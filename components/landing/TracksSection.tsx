    ...
    >
      ...
      <div
        style={{
          ...
          margin: "0 0 24px",
          padding: "18px 0",
          borderTop: "1px dashed #dde3eb",
          borderBottom: "1px dashed #dde3eb",
        }}
      >
        {steps.map((step, i) => (
          <div
            ...
            style={{ gap: 14, padding: "7px 0", fontSize: 13.5 }}
          >
            <div
              style={{
                width: 22,
...
export function TracksSection() {
  return (
    ...
    >
      ...
      >
        เลือกเส้นทางที่ตรงกับสถานะของท่าน
      </h2>
      <p
        style={{
          fontSize: 16,
      ...
      >
        หลักสูตรของท่านอยู่ในขั้นตอนใด? ระบบแบ่งงานออกเป็น 2
        เส้นทางที่ทำงานต่อเนื่องกัน — เริ่มจาก Track 1 ก่อน แล้ว Track 2
        จะถูกปลดล็อกอัตโนมัติเมื่อได้รับอนุมัติ
      </p>
      ...
      >
        ...
        <TrackCard
          ...
          steps={[
            { label: "กรอกข้อมูลหลักสูตร + ผลลัพธ์การเรียนรู้", meta: "~10 นาที" },
            { label: "ระบุสมรรถนะและระดับชั้นปี", meta: "~5 นาที" },
            { label: "ตรวจสอบและส่งให้คณะกรรมการ", meta: "~2 นาที" },
          ]}
          footLeft={
            <>
              เริ่มต้น ·{" "}
              <b style={{ color: "#14202e", fontWeight: 700 }}>
                เปิดให้ทุกหลักสูตร
              </b>
            </>
          }
        ...
        <TrackCard
          ...
          steps={[
            { label: "Layer 1 · UNESCO AI Competency", meta: "มาตรฐานสากล" },
            { label: "Layer 2 · School + Industry Competency", meta: "เฉพาะคณะ" },
            { label: "รายงานผลการแมพและส่งออก", meta: "Excel · PDF" },
          ]}
          footLeft={
            <span
              className="inline-flex items-center"
