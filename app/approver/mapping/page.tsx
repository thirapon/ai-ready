                    ...
                    <tr key={r.id}>
                      ...
                      <td>
                        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                          ...
                          <a href={`/submit/print?id=${r.id}`} target="_blank" rel="noopener noreferrer"
                            title="ดาวน์โหลดรายงานหลักสูตรเป็น PDF"
                            style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11, fontWeight: 600, color: "#1a4f8a", textDecoration: "none", padding: "3px 8px", borderRadius: 6, background: "#eef4fb", border: "1px solid #dbe7f4", whiteSpace: "nowrap" }}>
                            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                            PDF
                          </a>
                        </div>
                      </td>
