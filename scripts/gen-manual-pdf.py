...
def build(pdf: ManualPDF):
    ...
    login_steps = [
        ...
        ("กรอกรหัสผ่านของคณะ", "รหัสผ่านจัดส่งโดยสำนักวิชาการ"),
    ...
    pdf.info_box("! ข้อควรระวัง",
        ...
        "หากต้องการเปลี่ยนรหัสผ่าน กรุณาติดต่อสำนักวิชาการ",
    ...
    pdf.draw_table(
        ...
        [
            ...
            [("ไม่อนุมัติ", {"color":DANGER}),
             "ไม่ผ่านการพิจารณา",
             "ติดต่อสำนักวิชาการเพื่อขอคำแนะนำ"],
        ],
        [30, W/2 - 10, W/2 - 20],
        ["C", "L", "L"]
    )
    ...
    pdf.draw_table(
        ...
        [
            ...
            [("ไม่อนุมัติ", {"color":DANGER}),
             ...
             "ติดต่อสำนักวิชาการเพื่อขอคำปรึกษา"],
        ],
    ...
    faqs = [
        ...
        ("หากลืมรหัสผ่านของคณะต้องทำอย่างไร?",
         "ติดต่อสำนักวิชาการหรือ IT ของมหาวิทยาลัยเพื่อขอรีเซ็ตรหัสผ่าน"),
    ...
    pdf.multi_cell(pdf.w - 48, 5,
        "สำนักวิชาการ มหาวิทยาลัยกรุงเทพ | ai-ready-eight.vercel.app | thirapon.w@bu.ac.th")
